...
<!-- UI Object -->
<form name = "frm" action="<c:url value='/board/auth/do-login' />" method="post">
	<fieldset>
		<legend>로그인</legend>
		...
		<tbody>
			...
			<td>
				<div class="item">
					...
					<input type="password" name="password" id="password_input" class="i_text" style="width:300px"> 
				</div>
			</td>
			</tr>			
		</tbody>
		...
		&nbsp;&nbsp;&nbsp;&nbsp;
				<input type="button" id="login" value="로그인" 	onclick = "dologin()">
				
			
        	<!--   <a href="<c:url value='/view-membership'/>" > 회원가입 </a> -->
        
	</div>
	</fieldset>
</form>
<form name = "frm2" action="<c:url value='/view-membership' />" method="post">
	<input type="button" id="login" value="회원가입" 	onclick = "domembership()">
</form>
<div>
